...
public class playerControlerV2 : MonoBehaviour
{
	...
	private float speedSelector;
	// throtle speed selector, from 0 (full stop) to 100 (full speed)
	public float speedSelectorFactor;
	// set the speed at which the selector go up or down
	...
	// current speed along Z axis
	private float RotationX;
	// current rotation speed around X axis
	private float RotationY;
	private float RotationZ;
	private float thrust;
	// current thrust power
	private float selectedThrust;
	// speedSelector * thrustMax / 100
	private int energy;
	// energy left
	...
	// coefficient used to simulate the surface on which air drag applies
	public int energyMax;
	// maximum of energy the ship can store
	public int energyRefillSpeed;
	// multiply per 50 to have the amount of energy refilled per second
	public int boostEnergyConsumption;
	// multiply per 50 to have the amount of energy used by boost each second
	public int weaponEnergyConsumption;
	// energy used for each shot
	public float stabilizatorThrust;
	// multiply the drag effect along X and Y axis. the higher this factor, the less the ship will drift
	public float stabilizatorThrustBoost;
	// bonus thrust granted by boost
	public float thrustMax;
	// maximum engines thrust power
	public float thrustBoost;
	// bonus thrust granted by boost
	public float thrustFactor;
	// thrust increment each update
	public float brakeFactor;
	// how much brake is efficient
	public float pitchSpeed;
	// speed at which the ship can pitch
	public float yawSpeed;
	// speed at which the ship can yaw
	public float rollSpeed;
	// speed at which the ship can roll
	...
	void speedSelecting ()
	{
		...
		selectedThrust = (speedSelector / 100) * thrustMax;
	}
